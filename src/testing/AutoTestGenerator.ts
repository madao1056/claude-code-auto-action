...
export class AutoTestGenerator {
  ...
  private extractParameters(node: ts.FunctionLikeDeclaration): Array<{ name: string; type: string; optional: boolean }> {
  ...
  private async generateTestCases(functions: FunctionInfo[], filePath: string): Promise<Map<string, TestCase[]>> {
  ...
  private generateValidInput(parameters: Array<{ name: string; type: string; optional: boolean }>): any[] {
  ...
  private generateInvalidInput(parameters: Array<{ name: string; type: string; optional: boolean }>): any[] {
    return parameters.map(param => {
      switch (param.type) {
        case 'string':
          return null;
  ...
  private generateEdgeCaseInput(parameters: Array<{ name: string; type: string; optional: boolean }>): any[] {
    return parameters.map(param => {
      switch (param.type) {
        case 'string':
          return '';
...
`;
  ...
  private insertTestsIntoExisting(existingContent: string, funcName: string, testCases: TestCase[]): string {
